    ...
    function PostService(http) {
        ...
        this.http.get("/api/").subscribe(function (posts) {
            for (var _i = 0, posts_1 = posts; _i < posts_1.length; _i++) {
                var p = posts_1[_i];
                _this.posts.push(new _post__WEBPACK_IMPORTED_MODULE_2__["Post"](p.titulo, p.subtitulo, p.mensagem, p.arquivo, p.id, p.likes));
            }
        });
    }
...
var Post = /** @class */ (function () {
    function Post(titulo, subtitulo, mensagem, arquivo, id, likes) {
        this.titulo = titulo;
...
module.exports = __webpack_require__(/*! /home/willian/docker/digital-tour2/resources/assets/meuapp/src/main.ts */"./src/main.ts");
