    ...
    <div class="">
        <div class="col-lg-12 col-md-12 col-xl-12">
            <div class="awesome user width-cover mt-5">
                ...
                <div class="container img-fundo" id="btnMostrarEsconder" style="background-image: url({{ url('storage/usersfundo/'.auth()->user()->cupphoto) }})"></div>
                @else
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tperfil" role="tabpanel">
                            <div class="card">
                                <div class="card-header textoperfil">
                                    ...
                                    <button id="edit-btn" type="button" class="btn btn-primary submit-form"><a href="{{ route('profile') }}">Editar</a></button>
                                </div>
                        ...
                        <div class="tab-pane" id="tfotos" role="tabpanel">
                            <div class="card card-gallery">
                                <div class="card-header text-gallery">
                                    <h5 class="card-header-text h5text-gallery">Galeria</h5>
                                    <form method="POST" action="{{ route('seusPostsUpdate') }}" class="md-form form-text-gallery" enctype="multipart/form-data">
                                        @csrf
                                        <input type="hidden" id="escondido" name="user_id">
                                        <div class="form-group mt-3 row d-inline-block div-text-gallery">
                                    ...
                                    <form method="POST" action="{{ route('seusPostsUpdate') }}" class="md-form" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group mt-3 row d-inline-block">
                                            <div class="file-field ml-3">
                                                <a class="btn-floating purple-gradient mt-0 float-left waves-effect waves-light">
                                                    <i class="fas fa-cloud-upload-alt" aria-hidden="true"></i>
                                                    <input type="file" id="uploadFile" class="form-control @error('photo') is-invalid @enderror" name="photo" value="">
                                                </a>
                                            </div>
                                            @error('photo')
                                            <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="media d-block d-md-flex mt-4">
                                                ...
                                                <div class="media-body text-center text-md-left ml-md-3 ml-0">
                                                    <h5 class="font-weight-bold mt-0">
                                                        ...
                                                        <a href="" class="pull-right text-default"><i class="fas fa-reply"></i></a>
                                                    </h5>
                                                    @if($value->photo != null)
